...
import { updateEvento } from '../../../Services/ServiceEvent';

const ModalEditEvento = ({ShowMdEditRol, setShowMdEditRol, MdItemEdit}) => {
    ...
    const guardar = () => {
        ...
        if(countMsg) {
            ...
            updateEvento(request, MdItemEdit.id).then((result) => {
                            ...
                            <div className='modal-body'>
                                ...
                                <div className="row-md">
                                    <div className="col-md col-md-12">
                                        ...
                                        <InputFormMd attribute={{type:'text', name:'name', value:Name, className:'inputModal', disabled:false, cheched:false, maxLength: 40}} handleChange={handleChange}></InputFormMd>
