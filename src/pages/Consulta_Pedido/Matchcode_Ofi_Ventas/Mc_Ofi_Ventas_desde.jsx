...
const Mc_Org_Ventas_desde = ({showofiventa, setshowofiventa, setofi_ventas_desde,ofi_ventas_desde,ofi_ventas_hasta,setofi_ventas}) => {
    ...
    function clickcelda(vkorgField) {
        setofi_ventas_desde(vkorgField);
                                        ...
                                        <section className="section-table-modal">
                                            <div className="container-table responsive-table-all">
                                                <table className="content-table ">
                                                    <thead>
                                                        <tr>
                                                            <th style={{textAlign: 'center'}}>Oficina de ventas</th>
