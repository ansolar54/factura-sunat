...
const Mc_Material_desde = ({ showmaterial, setshowmaterial, setmaterial_desde, material_desde, material_hasta, setmaterial }) => {
                            ...
                            {ViewInfo ? (
                                <>
                                    <section className="row" style={{ margin: 'auto', paddingTop: '50px' }}>
                                        ...
                                        <div className="col-sm-4">
                                            <InputForm attribute={{ name: 'mc_ItMaktx_desde', type: 'text', value: ItMaktx_desde, disabled: false, checked: false, matchcode: false, maxlength:30 }} handleChange={handleChange} />
                                        </div>
                                        <div className="col-sm-4">
                                            <InputForm attribute={{ name: 'mc_ItMaktx_hasta', type: 'text', value: ItMaktx_hasta, disabled: false, checked: false, matchcode: false, maxlength:30}} handleChange={handleChange} />
                                        </div>
