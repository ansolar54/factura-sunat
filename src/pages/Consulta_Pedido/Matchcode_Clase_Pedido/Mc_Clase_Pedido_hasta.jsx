...
import './Mc_Clase_Pedido_hasta.css';

const Mc_Clase_Pedido_hasta = ({showclasepedido, setshowclasepedido,
    setclase_pedido_hasta, clase_pedido_hasta,
   clase_pedido_desde,setclase_pedido}) => {
    ...
    function clickcelda(auartField) {
        setclase_pedido_hasta(auartField);
...
export default Mc_Clase_Pedido_hasta;