...
const Mc_Comercial_desde = ({
  ...
  useEffect(() => {
    ...
    if (comercial_desde != "") {
      ...
      if (comercial_hasta != "") {
        setcomercial([{ Sign: "I", Option: "EQ", Low: "", High: comercial_hasta }]);
      } else {
    ...
    function clickcelda(pernrField, nameField) {
        setcomercial_desde(pernrField);
        setcomercial_desde_value(nameField)
  ...
  function SearchComercial(page){
    ...
    let model = {
        IsNpag: page,
        IsRegxpag: IsRegxpag,
        IsPernr:codigo_input,
        IsName:descripcion_input
    }
...
export default Mc_Comercial_desde;
