...
const Mc_Org_Ventas_desde = ({showorgventa, setshoworgventa, setorg_ventas_desde,org_ventas_desde,org_ventas_hasta,setorg_ventas}) => {
    ...
    function clickcelda(vkorgField) {
        setorg_ventas_desde(vkorgField);
