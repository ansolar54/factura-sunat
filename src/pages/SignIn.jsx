    ...
    return(
        <div className="container-signin">
            ...
            <h4>Iniciar Sesión</h4>
                <Input attribute={{type:'text', className:'', name:'username'}} label={{value:'Usuario'}} div={{className:'container-sigin-data'}} handleChange={handleChange}/>
                <Input attribute={{type:'password', className:'', name:'password'}} label={{value:'Contraseña'}} div={{className:'container-sigin-data'}} handleChange={handleChange}/>
            <div className="container-sigin-btn">
                <BtnAcept attribute={{name:'Ingresar', classNamebtn:'btn_signin'}} onClick={SigIn}/>
            </div>
            { spinner &&
                <Spinner/>
            }
